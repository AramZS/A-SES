...
function add_scripts_ses(){
    ...
    if (is_front_page()) {
        wp_enqueue_script('cycle-ses', get_stylesheet_directory_uri() . '/mods/legacy/jquery.cycle.all.js', array('jquery'));
        wp_enqueue_script('tabber-ses', get_stylesheet_directory_uri() . '/mods/legacy/tabber.js', array('jquery'));
    }
}
