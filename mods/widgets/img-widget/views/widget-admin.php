...
<p><label for="<?php echo $this->get_field_id('description2'); ?>"><?php _e('Caption', 'image_widget'); ?>:</label>
<textarea rows="8" class="widefat" id="<?php echo $this->get_field_id('description2'); ?>" name="<?php echo $this->get_field_name('description2'); ?>"><?php echo format_to_edit($instance['description2']); ?></textarea></p>
